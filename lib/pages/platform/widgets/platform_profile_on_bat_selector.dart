...
class PlatformProfileOnBatSelector extends ReactiveYaruToggleButtons<String> {
  PlatformProfileOnBatSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_platform_profile_on_battery ??
              'label_platform_profile_on_battery'),
          headline: Text(
              context.l10n?.label_platform_profile_on_battery_headline ??
                  'label_platform_profile_on_battery_headline'),
          subtitle: Text(
              context.l10n?.label_platform_profile_on_battery_subtitle ??
