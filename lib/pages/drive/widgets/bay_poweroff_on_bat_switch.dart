...
class BayPoweroffOnBatSwitch extends ReactiveYaruSwitchListTile<String> {
  BayPoweroffOnBatSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_bay_poweroff_on_battery ??
              'label_bay_poweroff_on_battery'),
          subtitle: Text(context.l10n?.label_bay_poweroff_on_battery_subtitle ??
              'label_bay_poweroff_on_battery_subtitle'),
          headline: Text(context.l10n?.label_bay_poweroff_on_battery_headline ??
