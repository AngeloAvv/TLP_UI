...
class SoundPowerSaveOnBatField extends ReactiveYaruTextField {
  SoundPowerSaveOnBatField(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_sound_power_save_on_battery ??
              'label_sound_power_save_on_battery'),
          subtitle: Text(
              context.l10n?.label_sound_power_save_on_battery_subtitle ??
                  'label_sound_power_save_on_battery_subtitle'),
          headline: Text(
              context.l10n?.label_sound_power_save_on_battery_headline ??
