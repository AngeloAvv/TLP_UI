...
class RuntimePMOnAcSwitch extends ReactiveYaruSwitchListTile<String> {
  RuntimePMOnAcSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(AppLocalizations.of(context)?.label_runtime_pm_on_ac ??
              'label_runtime_pm_on_ac'),
          subtitle: Text(
              AppLocalizations.of(context)?.label_runtime_pm_on_ac_subtitle ??
                  'label_runtime_pm_on_ac_subtitle'),
          headline: Text(
              AppLocalizations.of(context)?.label_runtime_pm_on_ac_headline ??
