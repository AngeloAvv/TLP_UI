...
class RuntimePMOnBatSwitch extends ReactiveYaruSwitchListTile<String> {
  RuntimePMOnBatSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_runtime_pm_on_battery ??
              'label_runtime_pm_on_battery'),
          subtitle: Text(context.l10n?.label_runtime_pm_on_battery_subtitle ??
              'label_runtime_pm_on_battery_subtitle'),
          headline: Text(context.l10n?.label_runtime_pm_on_battery_headline ??
