...
class IntelGpuMinFreqOnAcSlider extends ReactiveYaruSlider {
  IntelGpuMinFreqOnAcSlider(
    super.context, {
    super.key,
    required super.formControlName,
  }) : super(
          title: Text(context.l10n?.label_intel_gpu_min_freq_on_ac ??
              'label_intel_gpu_min_freq_on_ac'),
          subtitle: Text(
              context.l10n?.label_intel_gpu_min_freq_on_ac_subtitle ??
                  'label_intel_gpu_min_freq_on_ac_subtitle'),
          headline: Text(
              context.l10n?.label_intel_gpu_min_freq_on_ac_headline ??
                  'label_intel_gpu_min_freq_on_ac_headline'),
          min: 0,
          max: 10000,
        );
