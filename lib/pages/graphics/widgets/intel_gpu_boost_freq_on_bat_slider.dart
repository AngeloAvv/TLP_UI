...
class IntelGpuBoostFreqOnBatSlider extends ReactiveYaruSlider {
  IntelGpuBoostFreqOnBatSlider(
    super.context, {
    super.key,
    required super.formControlName,
  }) : super(
          title: Text(context.l10n?.label_intel_gpu_boost_freq_on_battery ??
              'label_intel_gpu_boost_freq_on_battery'),
          subtitle: Text(
              context.l10n?.label_intel_gpu_boost_freq_on_battery_subtitle ??
                  'label_intel_gpu_boost_freq_on_battery_subtitle'),
          headline: Text(
              context.l10n?.label_intel_gpu_boost_freq_on_battery_headline ??
                  'label_intel_gpu_boost_freq_on_battery_headline'),
          min: 0,
          max: 10000,
        );
