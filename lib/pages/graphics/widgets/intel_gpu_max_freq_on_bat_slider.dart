...
class IntelGpuMaxFreqOnBatSlider extends ReactiveYaruSlider {
  IntelGpuMaxFreqOnBatSlider(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_intel_gpu_max_freq_on_battery ??
              'label_intel_gpu_max_freq_on_battery'),
          subtitle: Text(
              context.l10n?.label_intel_gpu_max_freq_on_battery_subtitle ??
                  'label_intel_gpu_max_freq_on_battery_subtitle'),
          headline: Text(
              context.l10n?.label_intel_gpu_max_freq_on_battery_headline ??
