...
class IntelGpuBoostFreqOnAcSlider extends ReactiveYaruSlider {
  IntelGpuBoostFreqOnAcSlider(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_intel_gpu_boost_freq_on_ac ??
              'label_intel_gpu_boost_freq_on_ac'),
          subtitle: Text(
              context.l10n?.label_intel_gpu_boost_freq_on_ac_subtitle ??
                  'label_intel_gpu_boost_freq_on_ac_subtitle'),
          headline: Text(
              context.l10n?.label_intel_gpu_boost_freq_on_ac_headline ??
