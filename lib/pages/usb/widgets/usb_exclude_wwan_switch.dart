...
class USBExcludeWWANSwitch extends ReactiveYaruSwitchListTile<String> {
  USBExcludeWWANSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(
              context.l10n?.label_usb_exclude_wwan ?? 'label_usb_exclude_wwan'),
          subtitle: Text(context.l10n?.label_usb_exclude_wwan_subtitle ??
              'label_usb_exclude_wwan_subtitle'),
          headline: Text(context.l10n?.label_usb_exclude_wwan_headline ??
