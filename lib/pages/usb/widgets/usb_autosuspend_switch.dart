...
class USBAutosuspendSwitch extends ReactiveYaruSwitchListTile<String> {
  USBAutosuspendSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(AppLocalizations.of(context)?.label_usb_autosuspend ??
              'label_usb_autosuspend'),
          subtitle: Text(
              AppLocalizations.of(context)?.label_usb_autosuspend_subtitle ??
                  'label_usb_autosuspend_subtitle'),
          headline: Text(
              AppLocalizations.of(context)?.label_usb_autosuspend_headline ??
