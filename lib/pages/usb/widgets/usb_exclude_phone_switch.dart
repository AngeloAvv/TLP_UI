...
class USBExcludePhoneSwitch extends ReactiveYaruSwitchListTile<String> {
  USBExcludePhoneSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(AppLocalizations.of(context)?.label_usb_exclude_phone ??
              'label_usb_exclude_phone'),
          subtitle: Text(
              AppLocalizations.of(context)?.label_usb_exclude_phone_subtitle ??
                  'label_usb_exclude_phone_subtitle'),
          headline: Text(
              AppLocalizations.of(context)?.label_usb_exclude_phone_headline ??
