...
class DevicesToDisableOnShutdownSelector
  ...
  DevicesToDisableOnShutdownSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_disable_on_shutdown ??
              'label_devices_to_disable_on_shutdown'),
          headline: Text(
              context.l10n?.label_devices_to_disable_on_shutdown_headline ??
                  'label_devices_to_disable_on_shutdown_headline'),
          subtitle: Text(
              context.l10n?.label_devices_to_disable_on_shutdown_subtitle ??
                  'label_devices_to_disable_on_shutdown_subtitle'),
          children: {
