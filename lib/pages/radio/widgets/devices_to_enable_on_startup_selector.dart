...
class DevicesToEnableOnStartupSelector
  ...
  DevicesToEnableOnStartupSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_enable_on_startup ??
              'label_devices_to_enable_on_startup'),
          headline: Text(
              context.l10n?.label_devices_to_enable_on_startup_headline ??
                  'label_devices_to_enable_on_startup_headline'),
          subtitle: Text(
              context.l10n?.label_devices_to_enable_on_startup_subtitle ??
