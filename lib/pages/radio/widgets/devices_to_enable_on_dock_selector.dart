...
class DevicesToEnableOnDockSelector
  ...
  DevicesToEnableOnDockSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_enable_on_dock ??
              'label_devices_to_enable_on_dock'),
          headline: Text(
              context.l10n?.label_devices_to_enable_on_dock_headline ??
                  'label_devices_to_enable_on_dock_headline'),
          subtitle: Text(
              context.l10n?.label_devices_to_enable_on_dock_subtitle ??
                  'label_devices_to_enable_on_dock_subtitle'),
          children: {
