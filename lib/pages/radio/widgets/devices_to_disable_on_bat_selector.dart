...
class DevicesToDisableOnBatSelector
  ...
  DevicesToDisableOnBatSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_disable_on_battery ??
              'label_devices_to_disable_on_battery'),
          headline: Text(
              context.l10n?.label_devices_to_disable_on_battery_headline ??
                  'label_devices_to_disable_on_battery_headline'),
          subtitle: Text(
              context.l10n?.label_devices_to_disable_on_battery_subtitle ??
                  'label_devices_to_disable_on_battery_subtitle'),
          children: {
