...
class DevicesToDisableOnUndockSelector
  ...
  DevicesToDisableOnUndockSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_disable_on_undock ??
              'label_devices_to_disable_on_undock'),
          headline: Text(
              context.l10n?.label_devices_to_disable_on_undock_headline ??
                  'label_devices_to_disable_on_undock_headline'),
          subtitle: Text(
              context.l10n?.label_devices_to_disable_on_undock_subtitle ??
                  'label_devices_to_disable_on_undock_subtitle'),
          children: {
