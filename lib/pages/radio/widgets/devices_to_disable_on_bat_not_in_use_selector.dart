...
class DevicesToDisableOnBatNotInUseSelector
  ...
  DevicesToDisableOnBatNotInUseSelector(
    ...
    required super.formControlName,
          ...
          title: Text(
              context.l10n?.label_devices_to_disable_on_battery_not_in_use ??
                  'label_devices_to_disable_on_battery_not_in_use'),
          headline: Text(context.l10n
                  ?.label_devices_to_disable_on_battery_not_in_use_headline ??
              'label_devices_to_disable_on_battery_not_in_use_headline'),
          subtitle: Text(context.l10n
                  ?.label_devices_to_disable_on_battery_not_in_use_subtitle ??
              'label_devices_to_disable_on_battery_not_in_use_subtitle'),
          children: {
