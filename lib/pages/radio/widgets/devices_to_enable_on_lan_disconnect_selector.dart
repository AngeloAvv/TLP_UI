...
class DevicesToEnableOnLANDisconnectSelector
  ...
  DevicesToEnableOnLANDisconnectSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_enable_on_lan_disconnect ??
              'label_devices_to_enable_on_lan_disconnect'),
          headline: Text(context
                  .l10n?.label_devices_to_enable_on_lan_disconnect_headline ??
              'label_devices_to_enable_on_lan_disconnect_headline'),
          subtitle: Text(context
                  .l10n?.label_devices_to_enable_on_lan_disconnect_subtitle ??
              'label_devices_to_enable_on_lan_disconnect_subtitle'),
          children: {
