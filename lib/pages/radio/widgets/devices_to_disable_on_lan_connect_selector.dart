...
class DevicesToDisableOnLANConnectSelector
  ...
  DevicesToDisableOnLANConnectSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_devices_to_disable_on_lan_connect ??
              'label_devices_to_disable_on_lan_connect'),
          headline: Text(
              context.l10n?.label_devices_to_disable_on_lan_connect_headline ??
                  'label_devices_to_disable_on_lan_connect_headline'),
          subtitle: Text(
              context.l10n?.label_devices_to_disable_on_lan_connect_subtitle ??
                  'label_devices_to_disable_on_lan_connect_subtitle'),
          children: {
