...
class AHCIRuntimePmOnBatSelector extends ReactiveYaruSwitchListTile<String> {
  AHCIRuntimePmOnBatSelector(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_ahci_runtime_pm_on_battery ??
              'label_ahci_runtime_pm_on_battery'),
          subtitle: Text(
              context.l10n?.label_ahci_runtime_pm_on_battery_subtitle ??
                  'label_ahci_runtime_pm_on_battery_subtitle'),
          headline: Text(
              context.l10n?.label_ahci_runtime_pm_on_battery_headline ??
