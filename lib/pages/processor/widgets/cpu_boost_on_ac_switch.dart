...
class CpuBoostOnAcSwitch extends ReactiveYaruSwitchListTile<String> {
  CpuBoostOnAcSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(
              context.l10n?.label_cpu_boost_on_ac ?? 'label_cpu_boost_on_ac'),
          subtitle: Text(context.l10n?.label_cpu_boost_on_ac_subtitle ??
              'label_cpu_boost_on_ac_subtitle'),
          headline: Text(context.l10n?.label_cpu_boost_on_ac_headline ??
