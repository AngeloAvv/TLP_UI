...
class CpuMaxPerfOnAcSlider extends ReactiveYaruSlider {
  CpuMaxPerfOnAcSlider(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_cpu_max_perf_on_ac ??
              'label_cpu_max_perf_on_ac'),
          subtitle: Text(context.l10n?.label_cpu_max_perf_on_ac_subtitle ??
              'label_cpu_max_perf_on_ac_subtitle'),
          headline: Text(context.l10n?.label_cpu_max_perf_on_ac_headline ??
