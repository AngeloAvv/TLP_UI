...
class CpuMinPerfOnAcSlider extends ReactiveYaruSlider {
  CpuMinPerfOnAcSlider(
    ...
    required super.formControlName,
          ...
          title: Text(AppLocalizations.of(context)?.label_cpu_min_perf_on_ac ??
              'label_cpu_min_perf_on_ac'),
          subtitle: Text(
              AppLocalizations.of(context)?.label_cpu_min_perf_on_ac_subtitle ??
                  'label_cpu_min_perf_on_ac_subtitle'),
          headline: Text(
              AppLocalizations.of(context)?.label_cpu_min_perf_on_ac_headline ??
