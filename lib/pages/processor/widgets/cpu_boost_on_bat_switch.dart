...
class CpuBoostOnBatSwitch extends ReactiveYaruSwitchListTile<String> {
  CpuBoostOnBatSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_cpu_boost_on_battery ??
              'label_cpu_boost_on_battery'),
          subtitle: Text(context.l10n?.label_cpu_boost_on_battery_subtitle ??
              'label_cpu_boost_on_battery_subtitle'),
          headline: Text(context.l10n?.label_cpu_boost_on_battery_headline ??
