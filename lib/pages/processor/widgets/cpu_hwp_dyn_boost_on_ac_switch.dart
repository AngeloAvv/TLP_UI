...
class CpuHwpDynBoostOnAcSwitch extends ReactiveYaruSwitchListTile<String> {
  CpuHwpDynBoostOnAcSwitch(
    ...
    required super.formControlName,
          ...
          title: Text(context.l10n?.label_hwp_dyn_boost_on_ac ??
              'label_hwp_dyn_boost_on_ac'),
          subtitle: Text(context.l10n?.label_hwp_dyn_boost_on_ac_subtitle ??
              'label_hwp_dyn_boost_on_ac_subtitle'),
          headline: Text(context.l10n?.label_hwp_dyn_boost_on_ac_headline ??
